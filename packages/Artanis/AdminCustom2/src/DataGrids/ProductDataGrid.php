        ...
        $this->addColumn([
            ...
            'wrapper' => function ($value) {
                if (!$value->delivery_attachment) {
                    ...
                    return '<a href="http://localhost/local/public/storage/' .$value->delivery_attachment. '" download> <img src="https://www.freeiconspng.com/uploads/download-icon-down-arrow-23.png" alt="Smiley face" height="25" width="25"> </a>';
            }
        ]);
    }
