 ...
 */
class GoldSmallbar24kDataGrid extends DataGrid
{
    protected $sortOrder = 'desc'; //asc or desc

    protected $index = 'sell';
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::connection('mysql2')->table('gold_live_price_small_24k')
                ->addSelect('gram', 'sell', 'label');
