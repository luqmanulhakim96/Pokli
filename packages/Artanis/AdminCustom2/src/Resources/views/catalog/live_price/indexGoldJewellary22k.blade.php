...
@section('content')
    ...
    <div class="content" style="height: 100%;">
        <div class="page-header">
          <div class="page-title">
            ...
            <div class="page-action">
                ...
                <a href="{{ route('admincustom2.catalog.gold_live_price_gold_jewellary_22k.edit') }}" class="btn btn-lg btn-primary">
                    Edit Price
                </a>
            </div>
        </div>
        ...
        <div class="page-content">
            @inject('emas', 'Artanis\AdminCustom2\DataGrids\GoldJewellary22kDataGrid')
            {!! $emas->render() !!}
        </div>
