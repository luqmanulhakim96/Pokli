    ...
    <div class="content" style="height: 100%;">
        <div class="page-header">
          <div class="page-title">
              <h1>LBMA Small Bar / Wafer (24k)</h1>
          </div>
            ...
            <div class="page-action">
                ...
                <a href="{{ route('admincustom2.catalog.gold_live_price_gold_smallbar_24k.edit') }}" class="btn btn-lg btn-primary">
                    Edit Price
                </a>
            </div>
        </div>
        ...
        <div class="page-content">
            @inject('emas', 'Artanis\AdminCustom2\DataGrids\GoldSmallbar24kDataGrid')
            {!! $emas->render() !!}
        </div>
