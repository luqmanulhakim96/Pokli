...
@section('content')
    ...
    <div class="content" style="height: 100%;">
        <div class="page-header">
          <div class="page-title">
            ...
            <div class="page-action">
                ...
                <a href="{{ route('admincustom2.catalog.gold_live_price_gold_bar_24k.edit') }}" class="btn btn-lg btn-primary">
                    Edit Price
                </a>
            </div>
        </div>
        ...
        <div class="page-content">
            @inject('emas', 'Artanis\AdminCustom2\DataGrids\GoldBar24kDataGrid')
            {!! $emas->render() !!}
        </div>
