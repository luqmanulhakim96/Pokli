...
namespace Artanis\AdminCustom\Repositories;
...
class BuybackRepository extends Repository
{
    ...
    public function generateIncrementId()
    {
        ...
        // dd($number);
        $increment_id = $lastPurchase->orderBy('id', 'desc')->limit(1)->first() ? $lastPurchase->orderBy('id', 'desc')->limit(1)->first()->increment_id : '000000';
