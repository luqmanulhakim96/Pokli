...
class PurchaseRepository extends Repository
{
    ...
    {
        $history = $this->model->where('activity','purchase')->where('id', $orderId)->first();
    ...
    public function generateIncrementId()
    {
        ...
        $increment_id = $lastPurchase->orderBy('increment_id', 'desc')->limit(1)->first() ? $lastPurchase->orderBy('id', 'desc')->limit(1)->first()->increment_id : '000000';
    ...
    public function generateInvoiceId()
    {
        ...
        $increment_id = $lastPurchase->where('activity', 'purchase')->orderBy('invoice_id', 'desc')->limit(1)->first()->invoice_id 
                        ? $lastPurchase->where('activity', 'purchase')->orderBy('invoice_id', 'desc')->limit(1)->first()->invoice_id : '000000';
