...
class EPPTenMonthsController extends Controller
{
    ...
    {
      $data = $this->calculatePriceTenMonthsPassValue();
      // dd($data);
    ...
    public function calculatePriceTenMonths()
    {
    ...
    public function calculatePriceTenMonthsPassValue()
    {
