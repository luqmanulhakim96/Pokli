...
namespace Webkul\BillPlz\Payment;
 ...
 */
class Standard extends BillPlz
{
    /**
     * Payment method code
     *
    ...
    {
        return route('billplz.standard.redirect');
    }
    ...
    public function getFormFields()
    {
        ...
        $fields = [
            ...
            'paymentaction'   => 'sale',
            'return'          => route('billplz.standard.success'),
            'cancel_return'   => route('billplz.standard.cancel'),
            'notify_url'      => route('billplz.standard.ipn'),
            'charset'         => 'utf-8',
