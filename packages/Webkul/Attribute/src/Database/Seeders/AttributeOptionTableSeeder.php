...
class AttributeOptionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('attribute_option_translations')->insert([
            ...
            ['id' => '41', 'locale' => 'en', 'label' => 'LBMA Gold Wafer-Dindar (24k) - 1 Dinar', 'attribute_option_id' => '41'],
            ['id' => '42', 'locale' => 'en', 'label' => 'LBMA Gold Wafer-Dindar (24k) - 5 Dinar', 'attribute_option_id' => '42'],
            ['id' => '43', 'locale' => 'en', 'label' => 'LBMA Gold Wafer-Dindar (24k) - 10 Dinar', 'attribute_option_id' => '43'],
