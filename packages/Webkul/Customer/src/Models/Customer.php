...
class Customer extends Authenticatable implements CustomerContract, JWTSubject
{
    ...
    protected $fillable = ['referral_id', 'first_name', 'last_name', 'gender', 'date_of_birth', 'email', 'ic', 'total_gold', 'total_silver', 'bank_name', 'bank_no', 'job_description', 'branch','heir_name', 'heir_relation', 'heir_phone_no', 'heir_ic', 'phone', 'password', 'customer_group_id', 'subscribed_to_news_letter', 'is_verified', 'token', 'notes', 'status'];
