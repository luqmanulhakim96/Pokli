...
class ExportController extends Controller
{
    protected $exportableGrids = [
        'OrderDataGrid', 'OrderInvoicesDataGrid', 'OrderShipmentsDataGrid', 'CustomerDataGrid', 'TaxRateDataGrid', 'ProductDataGrid', 'CMSPageDataGrid', 'PurchaseDataGrid', 'BuybackDataGrid', 'EasyPurchasePaymentRecordDataGrid', 'EasyPurchasePaymentRecordOrderDataGrid'
    ];
