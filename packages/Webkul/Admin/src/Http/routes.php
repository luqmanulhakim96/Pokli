    ...
    Route::prefix('admin')->group(function () {
        ...
        Route::group(['middleware' => ['admin']], function () {
            ...
            Route::prefix('sales')->group(function () {
                ...
                Route::get('/purchase', 'Artanis\AdminCustom\Http\Controllers\Sales\PurchaseController@index')->defaults('_config', [
                    'view' => 'admincustom::sales.purchase.index'
                ])->name('admincustom.sales.purchase.index');

                Route::get('/purchase/view/{id}', 'Artanis\AdminCustom\Http\Controllers\Sales\PurchaseController@view')->defaults('_config', [
